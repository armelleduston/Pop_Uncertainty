...
tic()
samples3 <- new_model(sim_data, exact = FALSE)
toc()
...
modeled_Ps_exact <- cbind(samples2$chain1[,paste0("P[", 1:100, "]")])
modeled_Ps_inexact <- cbind(samples3$chain1[,paste0("P[", 1:100, "]")])
...
print("Inexact benchmarking (new model) coverage")
