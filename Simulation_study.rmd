...
modeled_Ps_exact <- samples2$chain1[,paste0("P[", 1:200, "]")]
modeled_Ps_inexact <- samples3$chain1[,paste0("P[", 1:200, "]")]
...
## Questions
- Appropriate to sample using truncated discrete laplace? Or better to use regular laplace and then round and clamp? 
...
- Traceplots and convergence checks are not consistently good, how to proceed? (some runs, if data generation is conveneient it works well, other times no)
